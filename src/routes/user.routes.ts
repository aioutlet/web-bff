...
router.patch('/addresses/:id/default', userController.setDefaultAddress as unknown as RequestHandler);
...
router.patch('/payment-methods/:id', userController.updatePaymentMethod as unknown as RequestHandler);
router.delete('/payment-methods/:id', userController.deletePaymentMethod as unknown as RequestHandler);
router.patch('/payment-methods/:id/default', userController.setDefaultPaymentMethod as unknown as RequestHandler);
