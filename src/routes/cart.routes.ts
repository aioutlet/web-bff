 ...
 */
router.get('/', async (req: RequestWithCorrelationId, res: Response): Promise<void> => {
  try {
 ...
 */
router.post('/items', async (req: RequestWithCorrelationId, res: Response): Promise<void> => {
  try {
    const auth = requireAuth(req, res);
    if (!auth) return;
 ...
 */
router.delete('/', async (req: RequestWithCorrelationId, res: Response): Promise<void> => {
  try {
    const auth = requireAuth(req, res);
    if (!auth) return;
 ...
 */
router.post('/transfer', async (req: RequestWithCorrelationId, res: Response): Promise<void> => {
  try {
    const auth = requireAuth(req, res);
    if (!auth) return;
